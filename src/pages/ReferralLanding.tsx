...
import { Loader2, CheckCircle, AlertCircle, Send, Phone, Share2, Copy, ExternalLink } from 'lucide-react';
                ...
                <div className="flex items-center justify-center gap-3">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      const text = `Olha essa empresa que me indicaram! Dá uma olhada: ${url}`;
                  ...
                  <Button
                    ...
                    onClick={() => {
                      const url = window.location.href;
                      const text = `Olha essa empresa que me indicaram!`;
